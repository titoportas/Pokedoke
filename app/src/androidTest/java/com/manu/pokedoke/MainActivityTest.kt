...
//        IntentSubject.assertThat(receivedIntent).hasComponentClass(PokemonDetailActivity::class.java)
//        IntentSubject.assertThat(receivedIntent).extras().containsKey(PokemonDetailActivity.ARG_POKEMON_NAME)
//        IntentSubject.assertThat(receivedIntent).extras().containsKey(PokemonDetailActivity.ARG_POKEMON_IMAGE_URL)
//        IntentSubject.assertThat(receivedIntent).extras().string(PokemonDetailActivity.ARG_POKEMON_NAME)
